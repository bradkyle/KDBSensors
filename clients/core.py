...
class KDBSideCarSensor(pulumi.ComponentResource):
      """
      ...
      def __init__(self,
        ...
        # TODO config map and secret etc.
       ...
       self.monitoring_cluster.add_grafana_dashboard_graph(
            dashboard=qenv_dashboard,
            graph=Graph(title="qenv_graph_"+str(i), dataSource="Prometheus", targets=[])
       )
